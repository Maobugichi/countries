 ...
 const { state } = location
  ...
  const items = info.map(item => {
    return(
       ...
       />
       <section className={`transition-all duration-300 ease-in flex flex-col ${theme.bg}  w-full lg:mx-auto lg:mt-[4.5%] mt-[20%] lg:h-[100vh] h-[110vh] `}>
        <button className={`ml-[5.5%] mt-[20%] mb-10 w-[100px] lg:h-[40px] h-[50px] rounded-md shadow-md ${theme.txt} flex items-center justify-center`}><Link className="w-full flex items-center justify-center gap-3"  to="/"><svg stroke="currentColor" fill="currentColor" stroke-width="0" viewBox="0 0 16 16" height="1em" width="1em" xmlns="http://www.w3.org/2000/svg"><path fill-rule="evenodd" d="M15 8a.5.5 0 0 0-.5-.5H2.707l3.147-3.146a.5.5 0 1 0-.708-.708l-4 4a.5.5 0 0 0 0 .708l4 4a.5.5 0 0 0 .708-.708L2.707 8.5H14.5A.5.5 0 0 0 15 8z"></path></svg> back</Link></button>
